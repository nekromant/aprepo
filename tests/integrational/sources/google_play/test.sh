...
export PLAYSTORE_TOKEN="dummy_token_for_testing"

# Pre-populate cache with fixture
mkdir -p cache/google_play
cp ../../fixtures/test.apk cache/google_play/com.example.app.apk
